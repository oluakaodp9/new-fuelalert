...
$fuel_price_verified = $fuel_price->Verify_fuel_price_report();

if(!$fuel_price_verified){
    // No valid fuel_price id provided
    ...
    // tell the fuel_price no products found
    echo json_encode(
        array("message" => "fuel_price with ID:$fuel_price->id was not verified. Try again")
    );
    ...
    // tell the fuel_price
    echo json_encode(array("message" => "fuel_price verified successfully."));
}
