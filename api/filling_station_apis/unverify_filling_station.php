...
$filling_station_unverified = $filling_station->unverify_filling_station();

if(!$filling_station_unverified){
    // No valid filling_station id provided
    ...
    // tell the filling_station no products found
    echo json_encode(
        array("message" => "filling_station with ID:$filling_station->id was not unverified. Try again")
    );
    ...
    echo json_encode(array("message" => "filling_station unverified successfully."));
}
